...
namespace Dreamteck.Splines
{
    ...
    public class SplineAddress
    {
        ...
        public SplineResult Evaluate(double percent)
        {
            ...
            if (_elements.Length == 1) return _elements[0].computer.Evaluate(percent);
            SplineComputer comp;
        ...
        public void Exit(int exitDepth)
        {
            ...
            if (_elements[_elements.Length - 1].endPoint >= _elements[_elements.Length - 1].startPoint) _elements[_elements.Length - 1]._endPoint = -1;
